...
exports.default = function (dataObject, position) {
...
var GroupChat = {
    sendMessage: function sendMessage(message, distance) {
        ...
        return this._dataObject.addChild('chatmessages', { chatMessage: message, distance: distance, position: this.position.value.coords }).then(function (child) {
    ...
    onMessage: function onMessage(callback) {
        ...
        this._dataObject.onAddChild(function (child) {
            ...
            if (childData.distance && _this2._distance(_this2.position.coords, childData.position) > distance) return;
...
},{"./GroupChatMessage":9}],8:[function(require,module,exports){
'use strict';
...
var Communication = function Communication(name) {
...
var GroupChatHyperty = {
        ...
        return Promise.all(participants.map(function (p) {
            return _this.hypertyDiscoveryService.discoverHypertiesPerUser(p.email, p.domain).then(function (hyperties) {
                return Object.keys(hyperties).map(function (key) {
                    ...
                    return desc.descriptor.endsWith('GroupChatHyperty');
                }).sort(function (a, b) {
    ...
    create: function create(name, participants) {
        ...
        return this._getHyFor(participants).then(function (hyperties) {
            return _this2._createSyncher(name, hyperties);
        }).then(function (dataObjectReporter) {
            dataObjectReporter.onSubscription(function (event) {
                return event.accept();
            });
            return (0, _GroupChat2.default)(dataObjectReporter, _this2._position.data);
        });
    },
    onInvite: function onInvite(callback) {
        ...
        return this.syncher.onNotification(function (event) {
            if (event.schema === _this3.locationDescURL) {
                _this3.syncher.subscribe(_this3.locationDescURL, event.url).then(function (dataObject) {
                    _this3._position = dataObject;
                });
            } else if (event.schema === _this3.objectDescURL) {
                _this3.syncher.subscribe(_this3.objectDescURL, event.url).then(function (dataObject) {
                    return callback((0, _GroupChat2.default)(dataObject, _this3._position.data));
                });
            }
        });
    }
...
},{"./GroupChat":7,"service-framework/dist/HypertyDiscovery":1,"service-framework/dist/Syncher":2,"urijs":5}],9:[function(require,module,exports){
"use strict";
